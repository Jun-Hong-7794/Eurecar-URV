...
LRF_K_HORIZEN_CTRL_STRUCT.desired_h_dst = 400

LRF_K_HORIZEN_CTRL_STRUCT.error = 8
...
LRF_K_HORIZEN_CTRL_STRUCT.loop_sleep = 800
...
## Step6: Kinova Roll Down

KINOVA_MANIPULATE_STRUCT.mode = 3

KINOVA_MANIPULATE_STRUCT.x = ==
KINOVA_MANIPULATE_STRUCT.y = ==
KINOVA_MANIPULATE_STRUCT.z = ==

KINOVA_MANIPULATE_STRUCT.roll = 0.0069
KINOVA_MANIPULATE_STRUCT.pitch = 1.4989
KINOVA_MANIPULATE_STRUCT.yaw = 1.4660
...
## Step0: Valve Searching

/*1:Go To Left, 2:Go To Right*/
KINOVA_LRF_VALVE_SEARCHING_STRUCT.mode = 1

KINOVA_LRF_VALVE_SEARCHING_STRUCT.searching_lengh = 15
KINOVA_LRF_VALVE_SEARCHING_STRUCT.num_point_thresh = 10

KINOVA_LRF_VALVE_SEARCHING_STRUCT.height_thresh = 200

/*cm*/
KINOVA_LRF_VALVE_SEARCHING_STRUCT.offset = 6

KINOVA_LRF_VALVE_SEARCHING_STRUCT.s_deg = 10
KINOVA_LRF_VALVE_SEARCHING_STRUCT.e_deg = 170
KINOVA_LRF_VALVE_SEARCHING_STRUCT.maximum_lrf_dst = 800

KINOVA_LRF_VALVE_SEARCHING_STRUCT.loop_sleep = 800

KINOVA_LRF_VALVE_SEARCHING_FUNCTION()

A_Sleep(1000)

## Step6: Kinova Roll Up
...
/*KINOVA_MANIPULATE_STRUCT.roll = 2.0974
/*KINOVA_MANIPULATE_STRUCT.pitch = 1.5575
/*KINOVA_MANIPULATE_STRUCT.yaw = -2.2821

KINOVA_MANIPULATE_STRUCT.roll = -1.4759
KINOVA_MANIPULATE_STRUCT.pitch = 1.4933
KINOVA_MANIPULATE_STRUCT.yaw = 1.3547
...
KINOVA_FORCE_CTRL_STRUCT.force_threshold_x = 15
...
VALVE_SIZE_RECOG_STRUCT.release_pose_1 = 2100
VALVE_SIZE_RECOG_STRUCT.release_pose_2 = 2300

VALVE_SIZE_RECOG_STRUCT.force_threshold = 65

VALVE_SIZE_RECOG_STRUCT.trial = 36
VALVE_SIZE_RECOG_STRUCT.rotation_angle = 180

VALVE_SIZE_RECOG_STRUCT.retry_num = 2
